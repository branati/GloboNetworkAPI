...
urlpatterns = [
    # re_path(r'^get/finality/$', environment_vip_finality.handle_request,
    #     name='environemnt-vip.get.finality'),
    # re_path(r'^get/cliente_txt/$', environment_vip_cliente_txt.handle_request,
    #     name='environemnt-vip.get.cliente_txt'),
    # re_path(r'^get/ambiente_p44_txt/$', environment_vip_ambientep44_txt.handle_request,
    #     name='environemnt-vip.get.ambientep44_txt'),
    # re_path(r'^get/timeout/(?P<id_evip>[^/]+)/$', opt_vip_timeout.handle_request,
    #     name='option-vip.get.timeout'),
    re_path(r'^get/grupo-cache/(?P<id_evip>[^/]+)/$', opt_vip_grupocache.handle_request,
        name='option-vip.get.grupocache'),
    # re_path(r'^get/persistencia/(?P<id_evip>[^/]+)/$', opt_vip_persistencia.handle_request,
    #     name='option-vip.get.persistencia'),
    # re_path(r'^get/balanceamento/(?P<id_evip>[^/]+)/$', opt_vip_balanceamento.handle_request,
    #     name='option-vip.get.balanceamento'),
    # re_path(r'^get/rules/(?P<id_evip>[^/]+)(?:/(?P<id_vip>[^/]+))?/$', environment_vip_rules.handle_request,
    #     name='environment-vip.get.rules'),
    # re_path(r'^get/healthcheck/(?P<id_evip>[^/]+)/$', opt_vip_healthcheck.handle_request,
    #     name='environment-vip.get.healthcheck'),
    # re_path(r'^get/trafficreturn/(?P<id_evip>[^/]+)/$', opt_vip_trafficreturn.handle_request,
