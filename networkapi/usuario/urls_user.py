...
urlpatterns = [
    re_path(r'^$', user_add_resource.handle_request,
        name='user.add'),
    re_path(r'^all/$', user_get_all_resource.handle_request,
        name='user.get.all'),
    re_path(r'^(?P<id_user>[^/]+)/$', user_alter_remove_resource.handle_request,
        name='user.update.remove.by.pk'),
    re_path(r'^get/(?P<id_user>[^/]+)/$', user_get_by_pk_resource.handle_request,
        name='user.get.by.id'),
    re_path(r'^group/(?P<id_ugroup>[^/]+)/$', user_get_by_group_resource.handle_request,
        name='user.get.by.group'),
    re_path(r'^out/group/(?P<id_ugroup>[^/]+)/$', user_get_by_group_out_group_resource.handle_request,
        name='user.get.by.group.out.group'),
    re_path(r'^get/ldap/(?P<user_name>[^/]+)/$', user_get_by_ldap_resource.handle_request,
        name='user.get.ldap')
]
