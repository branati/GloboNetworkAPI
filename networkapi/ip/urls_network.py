...
urlpatterns = [
    re_path(r'^ipv4/id/(?P<id_rede4>[^/]+)/$', networkip4_get_resource.handle_request,
        name='network.ip4.get.by.id'),
    re_path(r'^ipv6/id/(?P<id_rede6>[^/]+)/$', networkip6_get_resource.handle_request,
        name='network.ip6.get.by.id'),
    re_path(r'^add/$', network_add_resource.handle_request,
        name='network.add'),
    re_path(r'^edit/$', network_edit_resource.handle_request,
        name='network.edit'),
    re_path(r'^create/$', network_edit_resource.handle_request,
        name='network.create'),
    re_path(r'^remove/$', network_remove_resource.handle_request,
        name='network.remove'),
    re_path(r'^ipv4/add/$', network_ipv4_add_resource.handle_request,
        name='network.ipv4.add'),
    re_path(r'^ipv4/(?P<id_network_ipv4>[^/]+)/deallocate/$', network_ipv4_deallocate_resource.handle_request,
        name='network.ipv4.deallocate'),
    re_path(r'^ipv6/add/$', network_ipv6_add_resource.handle_request,
        name='network.ipv6.add'),
    re_path(r'^ipv6/(?P<id_network_ipv6>[^/]+)/deallocate/$', network_ipv6_deallocate_resource.handle_request,
